...
public class SoftUniMSWordConverter
{
        ...
        string docDestFileName, string docTemplateFileName, bool appWindowVisible)
    {
        ...
        try
        {
            ...
            InsertLicenseText(docDestination, docTemplateFileName);
    ...
    static void InsertLicenseText(Document docDestination, string docTemplateFileName)
    {
        Console.WriteLine("Inserting license text from file {0} ...", docTemplateFileName);
        docDestination.Characters.Last.InsertFile(docTemplateFileName);
    }
}
